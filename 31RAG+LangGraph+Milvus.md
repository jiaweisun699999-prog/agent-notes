...
![image.png](./images/31RAG+LangGraph+Milvus_a385f2734aee4fc2bb85d0d66a5cec05_e48be6.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_f375fbe38fc54290be2d13b2a797caae_4b2ef4.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_e8ff2144dae74630a5991f16e5fb9f51_5d3a3a.png)

![image.png](./images/31RAG+LangGraph+Milvus_5db76dccfc864d6bb7a69a975f7e070b_cf3b41.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_c2d73ad2ef6141aba2036ecdc0313f37_55bd39.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_b248ad40f5e6443fa9a1019ad5c473c6_79f586.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_5ceabaabf5b143ebad62432b23fd2a1a_64d914.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_f1957bf5530b4f6e99e15b01bc2d7996_0f94a7.png)

![image.png](./images/31RAG+LangGraph+Milvus_bf36fc0f5c174c3b8e29b32487ebb31a_8b2794.png)

![image.png](./images/31RAG+LangGraph+Milvus_3f762c72890548729d7451efae7d6231_715483.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_98ce892aadbe43a980fd707c1492a793_7dabf6.png)

![image.png](./images/31RAG+LangGraph+Milvus_9f88dd1c71dc440e9e116cc91f3c0ce4_52e0b3.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_6549ecff773540749fd264d53d07da30_e21a7e.png)

![image.png](./images/31RAG+LangGraph+Milvus_d6e5024eb2fb4317881f11b4e2c4c0cf_a87b17.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_53eadb5b607c402da73feb8c92c0b7e0_ab414e.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_9b640dc51c694f0296f12038a666ccd0_132d8d.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_1783805afaf74f2ea01bce61e173f355_eb716e.png)

## 5、重新排名

下图展示了在 Milvus 中执行混合搜索的过程，并强调了重排在此过程中的作用。

![reranking_process](./images/31RAG+LangGraph+Milvus_multi-vector-rerank_e29e8c.png)
...
* **排名融合** ：RRF 算法对每个检索器的排名进行权衡和合并。计算公式如下
  ![rrf-ranker](./images/31RAG+LangGraph+Milvus_rrf-ranker_ba95c1.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_b4183de37ab947d6b71fa971f8bf5b7b_f60083.png)
...
![image.png](./images/31RAG+LangGraph+Milvus_c20e2a5a5bbb41ac90498e4b527c99fc_4bbe3f.png)
